...
//		if(searchList.size() == 0) {
	...
	private void removeBook() {
		...
		System.out.println("제거할 책 인덱스를 작성하세요 : ");
		int index = sc.nextInt();
		
		String book = service.removeBook(index);
		if(book == null) {
	...
	private void updateBook() {
		...
		//아래 book에 저장된 주소가 같음.
		BookDTO book = service.seletIndex(index); //서비스에 indexx를
		
		if(book == null) { // 북이 널인 경우
			System.out.println("해당 인덱스에 책이 존재하지 않습니다");
			return;
		}
		//책이 존재하면 가격 입력 받기
