...
public class WrapperService {
	...
	public void test1() {
		...
		//Integer wrap1 = new Integer(num2);
...
//		List<int> list = new ArrayList<int>();
		...
		list.add(100); // (int)100 -> (Integer) 100
					   // Auto Boxing이 자동으로 일어남 int 100이 Integer 100으로 변환
		...
		//향상된 for문
		// 좌변 : 각 index(요소) 값을 얻어와 저장할 변수
		// 우변 : 배열또는 콜렉션
		for (int i : list) {
			// Auto Unboxing 이 자동으로 일어남 int 자동 변환
		...
		//정수형 / 실수형 공통 필드
			...
			System.out.println("-----------------------------");
			//String 자료형을 Number("123") -> 123 숫자로 변경 가능
			...
			int num5 = 500;
			String change1 = num5 + ""; //빈칸은 String "권장하지 않는 방법"
