...
public class ThrowsService {
	...
	public void test5() {
		...
		do {
			...
			try {
				...
				input = sc.nextInt(); //정수 아닌값 일력하면 예외 발생
				sc.nextLine();
				...
				case 0 : System.out.println("***종료했습니다.***"); break;
	...
	public void divNum() { /*throws RuntimeException*/
		...
		// -> 근데 왜 빨간줄이 안뜨지??
		//UncheckedExcpetion 이라서 빨간줄이 안뜸
	...
	public void inputKeyboard() throws IOException {
		...
		//br.readLine(); 입력된 한줄을 통 쨰로 읽어오는것.
