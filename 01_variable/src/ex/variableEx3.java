...
public class variableEx3 {
	...
	public static void main (String[] args) {
		...
		int result2 = (int)num2; //int 정수 강제 형변환
		
		System.out.println("num2 :" + num2); //123.456789
		System.out.println("result2 : " + result2);//123 앞부분만 가능
...
//		1 ~ 10 사이에 난수 (정수)
		...
		System.out.println("김의 번호 :" + (int)'김'); // 44608
		System.out.println("성의 번호 :" + (int)'성'); // 49457
		System.out.println("민의 번호 :" + (int)'민'); // 48124
		
		System.out.println("ㄱ의 번호 :" + (int)'ㄱ'); // 48124
		//int -> char
		System.out.println("ㄱ+1 다음은 :" + (char)('ㄱ' + 1)); // 쌍기억
		System.out.println("ㄱ+2 다음은 :" + (char)('ㄱ' + 2)); // ㄳ
		System.out.println("ㄱ+3 다음은 :" + (char)('ㄱ' + 3)); // ㄴ
...
//		NATIONAL_CODE = 12; 오류 발생 값 다시 대입 불가
