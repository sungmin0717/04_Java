...
public class LoopEx1 {
	...
	/*
	 * 1 부터 100사이의 정수 중 5의 배수의 합, 개수 구하기 sum, count
	 * 
	 */
	public void method4() {
		int sum = 0;
	...
	/*
	 * 입력 받은 단 출력하기 단, 입력 받은 단이 2~9 사이 숫자가 아니라면, 잘못이력하셨습니다. 출력
	 */
	public void method6() {
...
//		while(조건식) -> 조건식이 true 인 경우에 반복 수행
	...
	// == 몇회인지 모르겠지만 일단 끝날떄 까지 반복

	/*
	 * [구구단 출력하기v2] 입력 받은 단 출력하기 단, 입력 받은 단이 2~9 사이 숫자가 아니라면, 잘못이력하셨습니다. 출력 후 다시 단
	 * 입력 받기
	 * 
	 */
